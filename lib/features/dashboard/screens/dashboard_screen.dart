  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: metricas.when(
        ...
        data: (m) {
          // Filtragem da lista do "Plano de Voo" (mantida a lógica de cálculo por segurança, mas visual oculto)
          ...
          return ListView(
            ...
            children: [
              ...
              // NOVO MÓDULO: AGENDA INTELIGENTE INJETADO AQUI
              _AgendaInteligenteWidget(agendamentos: todosAgendamentos),
              const SizedBox(height: 24),
...
// -----------------------------------------------------------------------------
// NOVO WIDGET: AGENDA INTELIGENTE (WHITE-SPACE ALGORITHM)
// -----------------------------------------------------------------------------
class _AgendaInteligenteWidget extends StatelessWidget {
  const _AgendaInteligenteWidget({required this.agendamentos});
  final List<Agendamento> agendamentos;
  ...
  double _calcularPctSemana(DateTime segundaFeiraDaSemana) {
    int ocupado = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final pctSemanaAtual = _calcularPctSemana(segundaSemanaAtual);
    final pctProximaSemana = _calcularPctSemana(segundaProximaSemana);
          ...
          children: [
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                const Text('Agenda Inteligente & Encaixes', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ],
            ),
            const SizedBox(height: 4),
            Text('Acompanhe sua taxa de ocupação e horários livres.', style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('👇 SEMANA ATUAL', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.grey)),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('⏭️ PRÓXIMA SEMANA', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.grey)),
